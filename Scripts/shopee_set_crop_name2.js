const cropName = '軟糖,發酵乳,布丁,4蝦幣,3蝦幣,2蝦幣,1蝦幣,60蝦幣黃金樹,30蝦幣黃金樹,黃金樹,發財樹'; // ← 把大布丁改成想要的種子關鍵字，改完之後按「執行」即可。例如：大布丁、口香糖、養樂多、豆漿、牛奶糖、4蝦幣...
...
async function saveAutoCropName() {
  return new Promise((resolve, reject) => {
    try {
      ...
      const save1 = $persistentStore.write(cropName, 'autoCropSeedName');
