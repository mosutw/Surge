        ...
        if (response.status === 200) {
          ...
          try {
            if (obj.msg === 'success') {
              ...
              RewardList = obj.data.item_list.filter(item => item.name.includes("3 蝦幣") || item.name.includes("1.5 蝦幣") ).sort((a, b) => parseFloat(b.name.split(' ')[0]) - parseFloat(a.name.split(' ')[0]));
